...
export default class extends Controller {
  static values = {
    ...
    connect() { 
      ...
      this.questionId = event.target.closest('li').dataset.questionId;
        ...
        event.target.dataset.startingPosition = event.target.closest('li').dataset.index;
  ...
  //       event.preventDefault(); 
      ...
      drop(event) {    
        ...
        const url="/questions/reorder?question_id=" +this.questionId + "&order=" + newPosition+"&survey_id="+event.target.closest('li').dataset.surveyId;
