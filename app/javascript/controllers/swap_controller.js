...
export default class extends Controller {
  ...
  mouseenter() {
    this.textTarget.innerHTML = `<span class="inline-flex items-center ml-2 px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-800 whitespace-nowrap">${"Continue To Edit"}
